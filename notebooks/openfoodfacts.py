# %%
import pandas as pd
   # quantidade de produtos que deseja no dataset final
for i in (500,1000,2500,10000):
    ...
    df_final[["code", "product_name", "countries","brands"]].to_csv(f"../data/ean13_{i}_dataset.txt", index=False, header=False)
